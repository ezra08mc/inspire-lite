...
if (!empty($student_name)) {
    $name_array = explode(' ', $student_name);
...
<head>
    ...
    <title>INSPIRE LITE - Portal Akademik</title>
            ...
            <div class="user-panel">
                ...
                <div class="account-interaction-wrapper pc-only-wrapper">
                    <div class="profile-clickable-zone" id="profileMenuBtn">
                        ...
                        <div class="user-meta">
                            <span class="user-name-text"><?= htmlspecialchars($student_name ?: 'Budi Santoso') ?></span>
                    ...
                    <div class="dropdown-panel-account" id="accountDropdown">
                        <div class="dropdown-account-header">
                            <div class="avatar-circle"><?= htmlspecialchars($initials) ?></div>
                            <div>
                                <p class="head-title"><?= htmlspecialchars($student_name ?: 'Budi Santoso') ?></p>
        ...
        <main class="dashboard-viewport">
            <section class="hero-banner">
                <div class="hero-title">
                    <h1>Halo, <?= htmlspecialchars(explode(' ', $student_name ?: 'Budi')[0]) ?>! 👋</h1>
                    <p><?= htmlspecialchars($study_program ?: 'Teknik Informatika') ?> · Semester 6 · TA <?= htmlspecialchars($academic_year) ?></p>
                </div>
