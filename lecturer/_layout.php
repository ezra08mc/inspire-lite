...
if (!empty($lecturer_name)) {
    ...
    $initials = strtoupper(
        substr((string) ($name_array[0] ?? ""), 0, 1) .
            substr((string) ($name_array[1] ?? ""), 0, 1),
    );
    if ($initials === "") {
        $initials = "BS";
    }
...
<aside class="sidebar" id="sidebarMenu">
    ...
    <nav class="sidebar-menu">
        ...
        <a href="dashboard.php" class="menu-item <?= $activePage ===
        "dashboard.php"
            ? "active"
            : "" ?>">
            <svg viewBox="0 0 24 24"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg> BERANDA
        </a>
        <a href="profile.php" class="menu-item <?= $activePage === "profile.php"
            ? "active"
            : "" ?>">
        ...
        <div class="submenu-items" style="display: none;">
            <a href="announcements.php" class="sub-menu-link">
                ...
                Pengumuman <span class="nav-badge"><?= count(
                    $announcements,
                ) ?></span>
            </a>
        </div>

        <div class="menu-category-toggle expanded" onclick="toggleSubmenu(event, this)">
        ...
        <div class="submenu-items" style="display: flex;">
            <a href="schedule.php" class="sub-menu-link <?= $activePage ===
            "schedule.php"
                ? "active-sub"
                : "" ?>">
            ...
            <a href="courses.php" class="sub-menu-link <?= $activePage ===
            "courses.php"
                ? "active-sub"
                : "" ?>">
            ...
            <a href="attendance.php" class="sub-menu-link <?= $activePage ===
            "attendance.php"
                ? "active-sub"
                : "" ?>">
                <svg viewBox="0 0 24 24"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg> Absensi
            </a>
            <a href="assignments.php" class="sub-menu-link <?= $activePage ===
            "assignments.php"
                ? "active-sub"
                : "" ?>">
            ...
            <a href="grading.php" class="sub-menu-link <?= $activePage ===
            "grading.php"
                ? "active-sub"
                : "" ?>">
            ...
            <a href="materials.php" class="sub-menu-link <?= $activePage ===
            "materials.php"
                ? "active-sub"
                : "" ?>">
            ...
            <a href="advising.php" class="sub-menu-link <?= $activePage ===
            "advising.php"
                ? "active-sub"
                : "" ?>">
        ...
        <div class="submenu-items" style="display: none;">
            <a href="reports.php" class="sub-menu-link <?= $activePage ===
            "reports.php"
                ? "active-sub"
                : "" ?>">
