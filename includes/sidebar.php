...
<aside class="sidebar" id="sidebarMenu">
    ...
    <nav class="sidebar-menu">
        ...
        <?php if ($role === "student"): ?>
            <a href="<?= $base_path ?>student/index.php" class="menu-item <?= $current_page === "dashboard" ? "active" : "" ?>">
                <svg viewBox="0 0 24 24"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg> BERANDA
            </a>
            <a href="<?= $base_path ?>student/profile.php" class="menu-item <?= $current_page === "profile" ? "active" : "" ?>">
        ...
        <?php elseif ($role === "admin"): ?>
            <a href="<?= $base_path ?>admin/dashboard.php" class="menu-item <?= $current_page === "dashboard" ? "active" : "" ?>">
                <svg viewBox="0 0 24 24"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg> BERANDA
            </a>
            <div class="menu-category-toggle <?= in_array($current_page, ["manage_users", "provisions"]) ? "expanded" : "" ?>" onclick="toggleSubmenu(this)">
                <svg viewBox="0 0 24 24"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4z"/></svg>
                <span>PENGELOLAAN PENGGUNA</span>
                <svg class="arrow <?= in_array($current_page, ["manage_users", "provisions"]) ? "down" : "" ?>" viewBox="0 0 24 24"><path d="M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z"/></svg>
            </div>
            <div class="submenu-items" style="display: <?= in_array($current_page, ["manage_users", "provisions"]) ? "flex" : "none" ?>;">
                <a href="<?= $base_path ?>admin/users/manage.php" class="sub-menu-link <?= $current_page === "manage_users" ? "active" : "" ?>">
                ...
                <a href="<?= $base_path ?>admin/users/provisions.php" class="sub-menu-link <?= $current_page === "provisions" ? "active" : "" ?>">
        ...
        <?php elseif ($role === "lecturer"): ?>
            <a href="<?= $base_path ?>lecturer/dashboard.php" class="menu-item <?= $current_page === "dashboard" ? "active" : "" ?>">
                <svg viewBox="0 0 24 24"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg> BERANDA
            </a>
            <a href="<?= $base_path ?>lecturer/profile.php" class="menu-item <?= $current_page === "profile" ? "active" : "" ?>">
                <svg viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"/></svg> PROFIL
            </a>
            <a href="<?= $base_path ?>lecturer/schedule.php" class="menu-item <?= $current_page === "schedule" ? "active" : "" ?>">
                <svg viewBox="0 0 24 24"><path d="M19 3h-1V1h-2v2H8V1H6v2H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V8h14v11z"/></svg> JADWAL
            </a>
        <?php endif; ?>
